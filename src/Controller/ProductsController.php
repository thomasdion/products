...
class ProductsController extends ControllerBase implements ContainerInjectionInterface {
  ...
  /**
   * Page title callback for a products Entity  revision.
   *
   * @param int $products_revision
   *   The products Entity  revision ID.
   *
  ...
  /**
   * Generates an overview table of older revisions of a products Entity .
   *
   * @param \Drupal\products\Entity\ProductsInterface $products
   *   A products Entity  object.
   *
   * @return array
  ...
  public function revisionOverview(ProductsInterface $products) {
    ...
    $revert_permission = (($account->hasPermission("revert all products Entity revisions") || $account->hasPermission('administer products Entity entities')));
    $delete_permission = (($account->hasPermission("delete all products Entity revisions") || $account->hasPermission('administer products Entity entities')));
